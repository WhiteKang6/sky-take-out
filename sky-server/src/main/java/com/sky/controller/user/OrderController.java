...
public class OrderController {
    ...
    public Result<OrderSubmitVO> ordersSubmit(@RequestBody OrdersSubmitDTO ordersSubmitDTO){
    ...
    public Result<PageResult> historyOrderList(OrdersPageQueryDTO ordersPageQueryDTO){
        ...
        PageResult pageResult = orderService.historyOrderList(ordersPageQueryDTO);
